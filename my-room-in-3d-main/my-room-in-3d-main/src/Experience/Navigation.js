...
export default class Navigation {
    ...
    setView() {
        ...
        this.view.spherical = {}
        this.view.spherical.value = new THREE.Spherical(40, Math.PI * 0.35, - Math.PI * 0.25)
        ...
        this.view.spherical.limits.radius = { min: 10, max: 70 }
        ...
        this.view.drag.sensitivity = 0.06
        this.view.drag.alternative = false

        this.view.zoom = {}
        this.view.zoom.sensitivity = 0.002
        ...
        //     // this.view.down(_event.clientX, 0)
        ...
        this.view.onMouseMove = (_event) => {
            ...
            this.rotation =
                ((_event.clientX - window.innerWidth / 2) * 2) / window.innerWidth;

            this.view.move(_event.clientX * 5, _event.clientY * 5)
        }
